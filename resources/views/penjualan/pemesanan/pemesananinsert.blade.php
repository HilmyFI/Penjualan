        ...
        <div class="bs-stepper-content">
            <form method="POST" action="/pemesanans">
                ...
                <div id="test-l-1" class="content">
                    ...
                    <div class="d-flex justify-content-center">
                        <label class="col-sm-4 col-form-label" for="penawaran_id">Buat Pesanan Berdasarkan Penawaran</label>
                        <div class="col-sm-4">
                            <select class="form-control" id="penawaran_id" name="penawaran_id">
                                <option value="">--- Pilih Penawaran ---</option>
                                @foreach ($penawarans as $penawaran)
                                <option id="penawaran_data" value="{{$penawaran->id}}">{{ $penawaran->kode_penawaran }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
