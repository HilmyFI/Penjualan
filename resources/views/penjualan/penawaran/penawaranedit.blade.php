...
@section('halaman', 'Edit Penawaran')
...
<div class="d-flex justify-content-center">
    <div id="stepper" class="bs-stepper align-self-end" style=" width:80vw; max-height:60vh; color:black;">
        ...
        <div class="bs-stepper-content">
            <form method="POST" action="/penawarans/{{$penawaran->id}}">
                @method('put')
                @csrf
                <div id="test-l-1" class="content">
                    ...
                    <div style="height: 58vh;overflow: auto; color:black" class="mt-2">
                        <div class="form-group row mx-5 mb-5">
                            <label class="col-sm-3 col-form-label" for="customer_id">Supplier</label>
                            <div class="col-sm-9">
                                <select class="form-control" id="customer_id" name="customer_id">
                                    <option value="">--- Pilih Supplier ---</option>
                                    @foreach ($customers as $customer)
                                    <option value="{{$customer->id}}" {{$customer->id == "$penawaran->customer_id" ? "selected" : "" }}>{{ $customer->nama_customer }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row mx-5 mb-5">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="gudang" name="gudang">
                                    ...
                                    <option value="{{$gudang->id}}" {{$gudang->id == "$penawaran->gudang" ? "selected" : "" }}>{{ $gudang->nama_gudang }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mx-5 mb-5">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="number" class="form-control" id="biaya_lain" name="biaya_lain" value="{{$penawaran->biaya_lain}}" placeholder="-">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row mx-5 mb-5">
